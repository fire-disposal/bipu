...
class _SystemClient implements SystemClient {
  _SystemClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<HealthResponse> getApiHealth() async {
  ...
  @override
  Future<ReadyResponse> getApiReady() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<LiveResponse> getApiLive() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ApiInfoResponse> getApi() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
