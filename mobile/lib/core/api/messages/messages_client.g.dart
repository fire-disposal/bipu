...
class _MessagesClient implements MessagesClient {
  _MessagesClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<MessageResponse> postApiMessages({required MessageCreate body}) async {
  ...
  Future<MessagePollResponse> getApiMessagesPoll({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MessagePollResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/messages/poll',
  ...
  Future<FavoriteListResponse> getApiMessagesFavorites({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<FavoriteListResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<void> deleteApiMessagesMessageId({required int messageId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
