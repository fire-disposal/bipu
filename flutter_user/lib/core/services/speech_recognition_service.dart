...
class SpeechRecognitionService {
  ...
  Future<void> init() async {
    ...
    try {
      ...
      _isInitialized = true;
      dev.log('SpeechRecognitionService initialized successfully');
  ...
  Future<String?> _copyAssetToLocal(String assetPath) async {
    try {
      ...
      dev.log('Failed to copy asset $assetPath: $e', name: 'SpeechService');
      return null;
    }
  }
  ...
  void startListening(Stream<List<int>> audioStream) {
    if (!_isInitialized || _recognizer == null) {
      dev.log(
        'SpeechService not initialized. Call init() first.',
        name: 'SpeechService',
      );
      return;
    }
    ...
    _audioSubscription = audioStream.listen(
      ...
      onError: (e) {
        dev.log('Error in audio stream', name: 'SpeechService', error: e);
        stop();
      },
      cancelOnError: true,
    );
  ...
  Future<void> stop() async {
    try {
      ...
      dev.log('Error stopping recorder', name: 'SpeechService', error: e);
    }
    _stopCurrentStream();
  ...
  void _stopCurrentStream() {
    if (_stream != null) {
      try {
        ...
        dev.log('Error freeing stream', name: 'SpeechService', error: e);
      }
      _stream = null;
    }
  }
