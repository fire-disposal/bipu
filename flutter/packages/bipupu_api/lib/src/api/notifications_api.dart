...
import 'package:openapi/src/model/push_notification.dart';
...
class NotificationsApi {
  ...
  Future<Response<JsonObject>>
    ...
    final _path = r'/api/notifications/{notification_id}/cancel'.replaceAll(
        '{' r'notification_id' '}',
        encodeQueryParameter(_serializers, notificationId, const FullType(int))
            .toString());
  ...
  Future<Response<NotificationResponse>>
    ...
    final _path = r'/api/notifications/email';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(EmailNotification);
      _bodyData =
          _serializers.serialize(emailNotification, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<NotificationResponse>>
    ...
    required NotificationCreate notificationCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(NotificationCreate);
      _bodyData =
          _serializers.serialize(notificationCreate, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<NotificationResponse>>
    ...
    final _path = r'/api/notifications/push';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PushNotification);
      _bodyData =
          _serializers.serialize(pushNotification, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<JsonObject>>
    ...
    final _path = r'/api/notifications/{notification_id}'.replaceAll(
        '{' r'notification_id' '}',
        encodeQueryParameter(_serializers, notificationId, const FullType(int))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [NotificationStats] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationStats>>
    ...
    final _path = r'/api/notifications/stats';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    NotificationStats? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(NotificationStats),
    ...
    return Response<NotificationStats>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationList>> getNotificationsApiNotificationsGet({
    int? skip = 0,
    int? limit = 100,
    AppSchemasNotificationNotificationType? notificationType,
    AppSchemasNotificationNotificationStatus? status,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'notification_type': encodeQueryParameter(_serializers, notificationType,
          const FullType(AppSchemasNotificationNotificationType)),
      r'status': encodeQueryParameter(_serializers, status,
  ...
  Future<Response<JsonObject>>
    ...
    final _path = r'/api/notifications/{notification_id}/send'.replaceAll(
        '{' r'notification_id' '}',
        encodeQueryParameter(_serializers, notificationId, const FullType(int))
            .toString());
    final _options = Options(
  ...
  Future<Response<JsonObject>>
    ...
    final _path = r'/api/notifications/batch/send';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<NotificationResponse>>
    ...
    required int notificationId,
    required NotificationUpdate notificationUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(NotificationUpdate);
      _bodyData =
          _serializers.serialize(notificationUpdate, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
